...
namespace UnityIdeEx.Editor.ide_ex.Scripts.Editor.Windows.Assembly
{
    public sealed partial class AssemblyTree
    {
        ...
        protected override bool CanStartDrag(CanStartDragArgs args) => 
            args.draggedItem is AssemblyTreeItem || args.draggedItemIDs.All(x => FindItem(x, rootItem) is AssemblyTreeItem);
